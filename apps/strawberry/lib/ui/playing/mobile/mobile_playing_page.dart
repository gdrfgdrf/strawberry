...
class MobilePlayingPage extends AbstractUiWidget {
  final AudioPlayer audioPlayer;

  const MobilePlayingPage({super.key, required this.audioPlayer});
...
class _PlayingPageState
    extends AbstractUiWidgetState<MobilePlayingPage, EmptyDelegate> {
